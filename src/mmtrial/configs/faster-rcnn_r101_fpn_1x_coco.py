...
param_scheduler = [
    # ========== LR warm-up ==========
    # Based on the training batch size (8), each epoch has 104 iterations.
    # Therefore after ~5 epochs, the learning rate will be increased from
    # 0.02 * 0.001 = 0.00002 to 0.02.
    dict(
        begin=0,
        by_epoch=False,
        end=500,
